...
use App\Http\Controllers\Guru\NilaiExportController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // =====================================================================
    Route::middleware(['role:super_admin,tata_usaha'])
        ->prefix('manajemen')
        ->name('manajemen.')
        ->group(function () {
            // Kelola Pengguna
            ...
            Route::get('/users/{user}', [UserController::class, 'show'])->name('users.show'); // `show` tetap ada untuk konsistensi
    ...
    Route::middleware(['role:guru'])
        ...
        ->group(function () {
            ...
            Route::get('/nilai/{jadwal}/export', [NilaiExportController::class, 'export'])->name('nilai.export');
